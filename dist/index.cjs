...
var NestedDropdown = ({
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react27.useState)(null);
  const dropdownRef = (0, import_react27.useRef)(null);
  const searchInputRef = (0, import_react27.useRef)(null);
  const itemRefs = (0, import_react27.useRef)(/* @__PURE__ */ new Map());
  const flattenedData = (0, import_react27.useMemo)(
  ...
  const getCurrentLevelData = (0, import_react27.useCallback)(() => {
  ...
  const handleCategoryClick = (0, import_react27.useCallback)(
    (item, level, event) => {
      const children = getChildren(item);
  ...
  return /* @__PURE__ */ import_react27.default.createElement(
    ...
    isOpen && /* @__PURE__ */ import_react27.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react27.default.createElement("div", { className: "flex flex-col h-full" }, /* @__PURE__ */ import_react27.default.createElement("div", { className: "border-b border-gray-200 dark:border-gray-700 " }, /* @__PURE__ */ import_react27.default.createElement("div", { className: "relative" }, /* @__PURE__ */ import_react27.default.createElement(
        "input",
        {
          ref: searchInputRef,
          type: "text",
      ...
      ), /* @__PURE__ */ import_react27.default.createElement("div", { className: "absolute right-2 top-1/2 transform -translate-y-1/2" }, /* @__PURE__ */ import_react27.default.createElement("span", { className: "text-xs text-gray-400 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded" }, "Q")))), /* @__PURE__ */ import_react27.default.createElement(
        "div",
        {
          style: { maxHeight },
          className: "flex-1 overflow-y-auto bg-white rounded-b-lg dark:bg-gray-900"
        },
        /* @__PURE__ */ import_react27.default.createElement("div", { className: "" }, filteredData.length > 0 ? renderDropdownItems(filteredData, 0) : /* @__PURE__ */ import_react27.default.createElement("div", { className: "py-2 px-3 text-sm text-gray-500 dark:text-gray-400" }, "No results found"))
      )),
      activePath?.length > 0 && /* @__PURE__ */ import_react27.default.createElement("div", { className: "absolute left-full top-[36px] flex" }, activePath?.map((pathItem, level) => {
        ...
        return /* @__PURE__ */ import_react27.default.createElement(
          ...
          /* @__PURE__ */ import_react27.default.createElement("div", { className: "" }, renderDropdownItems(displayChildren, level + 1))
        );
      }))
    )
  );
